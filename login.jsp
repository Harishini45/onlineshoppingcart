                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    if(msg != null){
                    	if(msg.equals("notexist")){%>
                    		...
                    		<span class="h1 fw-bold mb-0" style="color:red">incorrect username or password</span>
                    	<%}
                    	else if(msg.equals("invalid")){%>
                    	<span class="h1 fw-bold mb-0" style="color:red">Some thing went wrong! Try Again !</span>
